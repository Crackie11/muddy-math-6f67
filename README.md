...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/muddy-math-6f67#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/muddy-math-6f67
```

A live public deployment of this template is available at [https://muddy-math-6f67.templates.workers.dev](https://muddy-math-6f67.templates.workers.dev)
